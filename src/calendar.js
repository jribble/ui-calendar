...
angular.module('ui.calendar', [])
    ...
    .directive('uiCalendar', ['uiCalendarConfig', '$locale', function(uiCalendarConfig, $locale) {
        ...
        return {
            restrict: 'A',
            scope: {eventSources:'=ngModel',resourceSources:'=ngResourceModel',days:'=ngDays',calendarWatchEvent: '&'},
            ...
            link: function(scope, elm, attrs, controller) {
                ...
                scope.$on('resize', function doResize () {
                    if(scope.calendar != null && scope.calendar.fullCalendar != null)
                        scope.calendar.fullCalendar('render');
                });

                function getOptions(){
                    options = { eventSources: sources, resources: resources, days: days };
